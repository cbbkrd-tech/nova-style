...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onCategorySelect }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex">
      ...
      {/* Menu Content */}
      <div className="relative w-[80%] max-w-xs bg-[#26272B] h-full shadow-2xl flex flex-col border-r border-gray-700">
        ...
        <nav className="flex flex-col p-6 space-y-6">
          <button
            ...
            className="text-xl font-medium uppercase tracking-widest text-white text-left hover:text-gray-400 transition-colors"
          >
            Kobiety
          </button>
          <button
